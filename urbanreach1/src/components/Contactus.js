const ContactUs = () => {
  return (
    <div className="row my-2 bg-info">
      <div className="col-6 px-5">
        <h3>Contact us</h3>
        <h6>Contact@urbanreach.in</h6>
        <h6>urbanreach2020@gmail.com</h6>
      </div>
      <div className="col-6 text-end ">
        <div class="row mt-4 btn-group">
          <div className="col">
            <a href="https://www.facebook.com/urbanreach.in">
              <svg
                width="16"
                height="16"
                viewBox="0 0 16 16"
          ...
          <div className="col">
            <a href="https://www.instagram.com/urbanreach.in/">
              <svg
                width="16"
                height="16"
                viewBox="0 0 16 16"
